...
lyrics = ' white lips, pale face breathing in snowflakes'
...
ed_sheeran = [list(names) for names in a_team]

## 5. Uppercasing And Lowercasing Strings ##

for rows in ed_sheeran:
    rows[1] = rows[1].upper()
...
ed_sheeran = ["".join(rows) for rows in ed_sheeran]
ed_sheeran_full = "\n".join(ed_sheeran)
